# Project 3 - *Tweeter (MySimpletTweets)*
...
* [ ] User can tap a tweet to **open a detailed tweet view**
  * [x] User can **take favorite (and unfavorite) or reweet** actions on a tweet (only retweet)
...
* [x] Added a cancel button to compose tweet
* [x] Added a retweet count 
* [x] Changed profile image to be a circle rather than a square
## Video Walkthrough
